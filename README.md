...
| Sum Partition problem - are 2 subsets with equal sum possible | recursion, DP bottom up | O(sum*n) | SumPartitionProblem.java |
| Maximum Length Chain of int Pairs | DP memoization | O(n^2) | MaxChainPairsPossible.java | 
***